...
export const MEMBERS: Record<MemberId, MemberProfile> = {
  yeonjae: {
    ...
    photo: "/images/members/yeonjae.png",
  ...
  hongkyung: {
    ...
    photo: "/images/members/hongkyung.png",
  ...
  hyerin: {
    ...
    photo: "/images/members/hyerin.png",
  ...
  sungjin: {
    id: "sungjin",
    name: "오성진",
    mbti: "INTJ", // T성향 기반 추정, TODO: 확정 필요
    oneLiner: "한줄 자기소개", // TODO: 팀원 제공
    traits: [
      "T발 너 C야? 라는 말을 듣는 사람",
    ...
    photo: "/images/members/sungjin.png",
  ...
  hyunjun: {
    ...
    photo: "/images/members/hyunjun.png",
